...
export default {
    ...
    async getChampionsData(){
        const response = await fetch("https://ddragon.leagueoflegends.com/cdn/10.22.1/data/en_US/champion.json");
    ...
    async getChampionSquareAsset(name) {
        ...
        return 'https://ddragon.leagueoflegends.com/cdn/10.22.1/img/champion/' + champion.image.full;
    },
